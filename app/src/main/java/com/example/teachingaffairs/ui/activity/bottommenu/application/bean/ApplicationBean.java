package com.example.teachingaffairs.ui.activity.bottommenu.application.bean;
...
public class ApplicationBean {
    ...
    public ApplicationBean(String mineSchedule){
        this.mineSchedule = mineSchedule;
    }
    public ApplicationBean(int textbook_picture,String textbook_name,String teacher_name,String time,String address){
    ...
    public ApplicationBean(String itemChild,String rb_verygood,String rb_good,String rb_justsoso,String rb_poor,String check){
    ...
    public ApplicationBean(int textbook_picture,String textbook_name,String teacher_name){
        this.textbook_picture = textbook_picture;
        this.textbook_name = textbook_name;
        this.teacher_name = teacher_name;
    }
    ...
    public ApplicationBean(String course_name,String course_time,String course_type,String total_points,
